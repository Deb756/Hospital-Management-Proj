...
/* Optional: Enhance the text contrast */
			...
			<div class="container-fluid text-light">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<a href="Login.jsp"><button type="button"
							class="btn btn-sm btn-secondary  mx-1 btn-nav">Patients
							Login</button></a> <a href="BookApointment.jsp"><button type="button"
				...
				<div class="carousel-item" style="height: 84vh !important;">
					...
					<div class="container">
						<div class="carousel-caption blur-background">
							...
							<p>
								<a class="btn btn-sm btn-primary" href="#">Register now</a>
							</p>
						</div>
					</div>
				</div>
				<div class="carousel-item active" style="height: 84vh !important;">
					<img src="cr1.jpg" class="d-block w-100" alt="..."
						style="height: 100% !important; object-fit: cover;">
					<div class="container">
						<div class="carousel-caption text-end blur-background">
							<h1>One more for good measure.</h1>
							<p>Some representative placeholder content for the third
								slide of this carousel.</p>
							<p>
								<a class="btn btn-sm btn-primary" href="#">Take Appointment</a>
							</p>
						</div>
					</div>
				</div>
  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				<div class="col-md-5">
					<img
						src="https://img.freepik.com/free-photo/medium-shot-female-nurse-hospital_23-2150796718.jpg?size=626&ext=jpg&uid=R162036504&ga=GA1.1.1727744415.1724652669&semt=ais_hybrid"
			...
			<div class="row featurette">
				...
				<div class="col-md-5 order-md-1">
					<img
						src="https://img.freepik.com/free-photo/disabled-senior-woman-with-walking-frame-sitting-hospital-waiting-area-medical-consultation-against-infection-with-coronavirus_482257-8530.jpg?size=626&ext=jpg&uid=R162036504&ga=GA1.1.1727744415.1724652669&semt=ais_hybrid"
						class="d-block w-100" alt="..."
						style="height: 100% !important; object-fit: cover;">
				</div>
			</div>
			...
			<div class="row featurette">
				...
				<div class="col-md-5">
					<img
						src="https://img.freepik.com/free-photo/confident-doctor-white-coat-face-mask-standing-hospital-ward_9975-22875.jpg?size=626&ext=jpg&uid=R162036504&ga=GA1.1.1727744415.1724652669&semt=ais_hybrid"
						class="d-block w-100" alt="..."
						style="height: 100% !important; object-fit: cover;">
				</div>
			</div>
